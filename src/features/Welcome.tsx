...
export const Welcome = () => {
  return (
    <Section>
      ...
      >
        <motion.h1
          className="leading-snug tracking-wide text-3xl md:text-4xl lg:text-5xl"
          variants={item}
        >
        ...
        <motion.div
          className="flex flex-row items-center gap-6 text-lg md:gap-8 md:text-xl lg:gap-10 lg:text-2xl"
          variants={item}
        >
