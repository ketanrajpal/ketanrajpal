...
export const Logo = ({ size }: { size: number }) => {
  ...
  return (
    ...
    >
      <g>
        <path
          d={`M21,0h1.1C27.8,0,33,2.4,37.6,7.1C41.2,11.4,43,16,43,20.9v0.9c0,1-0.7,1.8-2.2,2.3H40c-1.6-0.3-2.4-1.3-2.4-3
      ...
      <path
        d={`M28,10.1c1.7,0.3,2.5,1.2,2.5,2.5v0.3c0,1-1.2,2.8-3.5,5.3c-2.1,2-3.8,3.3-5.1,3.9v0.1c1.6,0.7,3.7,2.4,6.2,5.1
	...
	c-1.3-0.6-2-1.3-2-2.3v-0.6c0-1.1,0.7-1.9,2.2-2.3c5.9,0,10.5-2.4,13.9-7.3C25.8,10.8,26.8,10.1,28,10.1z`}
        fill={isDark ? "#FFFFFF" : "var(--color-secondary)"}
      />
    </motion.svg>
  );
};
